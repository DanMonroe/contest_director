export default function(server) {
      ...
      */
      ...
      ///** registration **/
      let reg1 = server.create("registration", {"contestId": contest1.id, "pilotclassId": pilotclass4.id, "pilotId": pilot1.id});
      let reg2 = server.create("registration", {"contestId": contest1.id, "pilotclassId": pilotclass4.id, "pilotId": pilot2.id});
